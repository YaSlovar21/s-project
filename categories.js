...
const categoriesPageMain = [
  {
    ...
    desc: `Изготовление многогранных опор освещения, многогранных опоры ЛЭП, 
    гранёных опор контактных сетей 
    электрифицированного транспорта и мачты освещения.`,
    pageId: 'oporyMain',
  },
  {
    title: "Высокомачтовые опоры",
    desc: `Изготовление многогранных мачт освещения, составные части которых проходят горячее цинкование.`,
    pageId: 'machty',
  },
  {
    title: "Кронштейны под светильники",
    desc: `Наша компания изготовит любой вид кронштейна под консольный светильник. 
    Кронштейны изготавливаются как на железобетонные опоры, так и на многогранные и круглые металлические.`,
    pageId: 'brackets',
  },
  {
    title: "Фундаменты под опоры",
    desc: `Мы производим все виды фундаментов и закладных элементов 
    под разные типы силовых и несиловых фланцевых круглых и граненых опор.`,
    pageId: 'fundamenty',
  },
];

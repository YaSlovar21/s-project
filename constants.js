...
const techNames = {
  ...
  "H": 'Высота опоры (надземной части)',
  "h1": 'Высота фундамента (подземной части)',
  "Dh": 'Диаметр в нижней части опоры',
  "Db": 'Диаметр в вехней части опоры',

  "H1": 'Высота приложения максимального горизонтального усилия P', //только для силовых
  "P": 'Максимальное горизонтальное усилие в точке опоры на высоте H1',
